  ...
  <transition name="modal">
    <div v-if="modelValue" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <!-- Modal content -->
        <div class="inline-block align-bottom bg-gradient-to-br from-gray-900 to-purple-900/100 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-sm text-gray-400 mt-1">Ежедневно с 9:00 до 21:00</p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-sm text-gray-400 mt-1">Ответим в течение 24 часов</p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div class="ml-4">
                  <p class="text-sm font-medium text-gray-400">Социальные сети</p>
              ...
              <div class="mt-8">
                ...
                <form @submit.prevent="submitForm">
                  <div class="space-y-4">
                    ...
                    <div>
                      <label for="message" class="block text-sm font-medium text-gray-400 mb-1">Сообщение</label>
                      <textarea
                        id="message"
